...
| `Not judged: 2 series not measured at the analyzed context commit; 3 series with too few points in the analyzed window.` | What the verdict does not cover, named reason by reason. The judged count and these reasons account for every series between them. |
