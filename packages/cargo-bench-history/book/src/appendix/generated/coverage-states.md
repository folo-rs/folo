...
| `nothing_in_scope` | Nothing was in scope at the analyzed context commit, so nothing was judged. | Nothing at the analyzed context commit: every accounted series was measured elsewhere. |
