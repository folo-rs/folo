...
| `full` | No notable changes detected. | The whole in-scope suite. This is the only silent state with no coverage qualification; the verdict remains no notable changes detected. |
