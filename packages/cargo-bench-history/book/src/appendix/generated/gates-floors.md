...
| `instruction_count` | 5 instructions | Code layout can shift these counts by a few units between builds of identical source, so a handful of them says nothing about what the code costs. |
