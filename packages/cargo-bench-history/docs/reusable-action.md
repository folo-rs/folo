...
remain downloadable even when they contain no findings. Migration from legacy sinks uses
explicit issue-title and placeholder-marker adoption; normal identity uses instance markers.
