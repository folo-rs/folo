//! Tests of the `define_pooled_dyn_cast!` macro with shared handles, separate from the main crate
...
// ========== Tests for all 8 handle types with shared handles ==========

#[test]
fn cast_managed_blind_pooled_shared_to_display_trait() {
...
#[test]
fn cast_managed_blind_pooled_mut_shared_to_display_trait() {
    let pool = BlindPool::new();
    let pooled_mut = pool.insert("Test string".to_string()).into_shared();
...
#[test]
fn cast_local_blind_pooled_shared_to_display_trait() {
...
#[test]
fn cast_local_blind_pooled_mut_shared_to_display_trait() {
    let pool = LocalBlindPool::new();
    let pooled_mut = pool.insert("Test string".to_string()).into_shared();
...
#[test]
fn cast_managed_pinned_pooled_shared_to_display_trait() {
...
#[test]
fn cast_managed_pinned_pooled_mut_shared_to_display_trait() {
    let pool = PinnedPool::new();
    let pooled_mut = pool.insert("Test string".to_string()).into_shared();
...
#[test]
fn cast_local_pinned_pooled_shared_to_display_trait() {
...
#[test]
fn cast_local_pinned_pooled_mut_shared_to_display_trait() {
    let pool = LocalPinnedPool::new();
    let pooled_mut = pool.insert("Test string".to_string()).into_shared();
...
// ========== Tests for raw pool removal via trait objects with shared handles ==========

#[test]
fn cast_raw_blind_pooled_shared_removal_shared() {
...
#[test]
fn cast_raw_blind_pooled_shared_removal_unique() {
    let mut pool = RawBlindPoolBuilder::new().build();
    let pooled_mut = pool.insert("Test string".to_string()).into_shared();
...
#[test]
fn cast_raw_opaque_pooled_shared_removal_shared() {
...
#[test]
fn cast_raw_opaque_pooled_shared_removal_unique() {
    let mut pool = RawOpaquePoolBuilder::new().layout_of::<String>().build();
    let pooled_mut = pool.insert("Test string".to_string()).into_shared();
...
#[test]
fn cast_raw_pinned_pooled_shared_removal_shared() {
...
#[test]
fn cast_raw_pinned_pooled_shared_removal_unique() {
    let mut pool = RawPinnedPoolBuilder::new().build();
    let pooled_mut = pool.insert("Test string".to_string()).into_shared();
