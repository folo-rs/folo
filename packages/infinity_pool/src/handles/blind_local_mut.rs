...
impl<T: ?Sized> UnwindSafe for LocalBlindPooledMut<T> {}
impl<T: ?Sized> RefUnwindSafe for LocalBlindPooledMut<T> {}
...
mod tests {
    ...
    assert_impl_all!(LocalBlindPooledMut<SendAndSync>: UnwindSafe, RefUnwindSafe);
