...
/// (and similarly for `LocalPooled`, `RawPooled` and `RawBlindPooled`)
/// where `T` implements the trait in question.
///
/// # Parameters
///
...
macro_rules! define_pooled_dyn_cast {
    ...
    ($trait_name:ident) => {
        $crate::__private_paste! {
            ...
            impl<T> [<PooledCast $trait_name>]<T> for $crate::RawPooled<T>
            where
                T: $trait_name + 'static,
            {
            ...
            impl<T> [<PooledCast $trait_name>]<T> for $crate::RawPooledMut<T>
            where
                T: $trait_name + 'static,
            {
            ...
            impl<T> [<PooledCast $trait_name>]<T> for $crate::RawBlindPooled<T>
            where
                T: $trait_name + 'static,
            {
            ...
            impl<T> [<PooledCast $trait_name>]<T> for $crate::RawBlindPooledMut<T>
            where
                T: $trait_name + 'static,
            {
    ...
    ($trait_name:ident<$($type_param:ident),+ $(,)?>) => {
        $crate::__private_paste! {
            ...
            impl<__PooledT> [<PooledCast $trait_name>]<__PooledT> for $crate::RawPooled<__PooledT>
            where
                __PooledT: 'static,
            {
            ...
            impl<__PooledT> [<PooledCast $trait_name>]<__PooledT> for $crate::RawPooledMut<__PooledT>
            where
                __PooledT: 'static,
            {
            ...
            impl<__PooledT> [<PooledCast $trait_name>]<__PooledT> for $crate::RawBlindPooled<__PooledT>
            where
                __PooledT: 'static,
            {
            ...
            impl<__PooledT> [<PooledCast $trait_name>]<__PooledT> for $crate::RawBlindPooledMut<__PooledT>
            where
                __PooledT: 'static,
            {
