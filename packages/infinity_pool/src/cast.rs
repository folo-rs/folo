...
macro_rules! define_pooled_dyn_cast {
    ...
    ($trait_name:ident) => {
        $crate::__private_paste! {
            ...
            impl<T> [<PooledCast $trait_name>]<T> for $crate::BlindPooled<T>
            where
                T: $trait_name + 'static,
            {
            ...
            impl<T> [<PooledCast $trait_name>]<T> for $crate::LocalBlindPooled<T>
            where
                T: $trait_name + 'static,
            {
            ...
            impl<T> [<PooledCast $trait_name>]<T> for $crate::BlindPooledMut<T>
            where
                T: $trait_name + 'static,
            {
            ...
            impl<T> [<PooledCast $trait_name>]<T> for $crate::LocalBlindPooledMut<T>
            where
                T: $trait_name + 'static,
            {
    ...
    ($trait_name:ident<$($type_param:ident),+ $(,)?>) => {
        $crate::__private_paste! {
            ...
            impl<__PooledT> [<PooledCast $trait_name>]<__PooledT> for $crate::BlindPooled<__PooledT>
            where
                __PooledT: 'static,
            {
            ...
            impl<__PooledT> [<PooledCast $trait_name>]<__PooledT> for $crate::LocalBlindPooled<__PooledT>
            where
                __PooledT: 'static,
            {
            ...
            impl<__PooledT> [<PooledCast $trait_name>]<__PooledT> for $crate::BlindPooledMut<__PooledT>
            where
                __PooledT: 'static,
            {
            ...
            impl<__PooledT> [<PooledCast $trait_name>]<__PooledT> for $crate::LocalBlindPooledMut<__PooledT>
            where
                __PooledT: 'static,
            {
