...
/// allows results to be popped from either end with strict deque semantics. Futures are
/// stored in a pool-backed allocation scheme and each future gets its own waker for
