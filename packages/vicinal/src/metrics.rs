...
const SCHEDULING_DELAY_MS_BUCKETS: &[Magnitude] = &[0, 20, 50, 100, 200, 500, 1000];
...
const EXECUTION_TIME_MS_BUCKETS: &[Magnitude] = &[0, 20, 50, 100, 200, 500, 1000, 2000, 5000];

thread_local! {
    /// Shared clock instance for telemetry.
    pub(crate) static CLOCK: RefCell<Clock> = RefCell::new(Clock::new());
