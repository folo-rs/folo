...
fn entrypoint(c: &mut Criterion) {
    ...
    group.bench_function("read_cell", |b| {
        b.iter_custom(|iters| {
            ...
            {
                let _span = read_cell_op.iterations(iters).thread_span();
    ...
    group.bench_function("string_formatting", |b| {
        b.iter_custom(|iters| {
            ...
            {
                let _span = string_op.iterations(iters).thread_span();
    ...
    group.bench_function("computation", |b| {
        b.iter_custom(|iters| {
            ...
            {
                let _span = computation_op.iterations(iters).thread_span();
