...
tests use the existing hardware-taking constructor with fake topology and pinning state. Static
extension tests initialize the underlying linked static wrapper through that constructor, exercising
global publication to initialized and untouched regions without acquiring real hardware. Cargo
integration tests exercise real constructors, the region-cached macro, and dynamic linked wrappers.
