...
and runs only the library unit tests; the seeded binary scenarios remain integration
tests. See the [design](docs/design.md) and [implementation guide](docs/implementation.md)
