...
mod static_assertions {
    ...
    use blind_pool::{LocalBlindPool, LocalBlindPoolBuilder, LocalPooled};
...
// Test that LocalPooled is NOT Send - see static_assertions module for compile-time verification
#[test]
fn local_pooled_is_not_send() {
    ...
    // Compile-time verification is done in the static_assertions module.
    let pool = LocalBlindPool::from(RawBlindPool::new());
...
// Test that LocalPooled is NOT Sync - see static_assertions module for compile-time verification
#[test]
...
// Test that LocalBlindPool is NOT Send - see static_assertions module for compile-time verification
#[test]
...
// Test that LocalBlindPool is NOT Sync - see static_assertions module for compile-time verification
#[test]
