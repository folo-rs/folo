...
fn main() {
    ...
    println!(
        "Single-threaded (1 thread): {single_threaded_duration:?}"
    );
    ...
    #[allow(clippy::cast_precision_loss, reason = "precision loss acceptable for display purposes")]
    let speedup = single_threaded_duration.as_nanos() as f64
        / multi_threaded_duration.as_nanos() as f64;
