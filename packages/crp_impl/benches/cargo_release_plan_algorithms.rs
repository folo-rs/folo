...
use crp_impl::__private::{benchmark_lockfile_closures, benchmark_patch_rendering};

// This benchmark ships in the crate archive, so it uses the registry-backed mimalloc
