...
use crp_impl::groups::Groups;
use crp_impl::lockfile::{ClosureChange, InstallationGraph};
...
use crp_impl::metadata::{WorkPackage, WorkTree};
use crp_impl::{LockfileClosureUnavailableError, ParseTomlError};
use semver::Version;
...
fn historical_paths_read_target_versions_from_their_own_workspace() {
    ...
    .unwrap();
    let mut installation = InstallationGraph {
